 ...
 * @author ajimenez
 */
public class SbbSummaObjectPoolFactory implements PoolObjectFactory {

	private static Logger logger = Logger.getLogger(SbbSummaObjectPoolFactory.class);
    ...
    public SbbSummaObjectPoolFactory(ServiceID serviceID, SbbComponent sbbComponent) {
    ...
    public boolean readyToRestore(Object o) {
        //Actions before restore.
        passivateObject(o);
        return true;
    }

    public void destroy(Object sbb) {
        try {
            destroyObject(sbb);
        }catch(Exception e){}
    }
    ...
    // OLD METHOD, BUT RECICLED AT THE MOMENT
    ...
    public void passivateObject(Object sbb) {
    	if (doTraceLogs) {
